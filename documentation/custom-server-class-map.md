# Custom C# Server Class Map (Schema v1)

This document lists the recommended C# classes to implement the protocol in the current project.
...
### 3.3 Routing and action execution
...
## 4. Logging and benchmark instrumentation
